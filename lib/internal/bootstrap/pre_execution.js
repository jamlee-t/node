...
// JAMLEE: 初始化线程的各类全局变量。lib/internal/main/run_main_module.js 中调用 expandArgv1 为 true。
...
// JAMLEE: expandArgv1 参数 1 是否变为绝对路径。
function patchProcessObject(expandArgv1) {
  ...
  // JAMLEE: 如果第2个参数不是 - 前缀。那么 process.argv[1] 会成为绝对路径。
